...
if (isset($_GET["callback"]) && !empty($_GET["callback"])) {
  $callback = $_GET["callback"];
	...
	// Headercall für ein JavaScript output
  	header("Content-Type: application/javascript");


/** 
 * Chapter Callback (nur für Shordcode in WordPress nutzen - für spätere implementierungen!)
 * #$datei = file("http://testpreview.reliveradio.de/stream/technique.chapters");			//original Relive
 * #$datei = file("http://cm.wikibyte.org/testcodes/neu-chapters/podlove-web-player/relive.datei"); 	//testfile
**/
  	echo $callback. "('";

	#### Tests - so muss die Ausgabe für den Standalone Player aussehen
	#
	# first (aktiv chapter) - läuft gerade
	 ...
	 *   Laufende Episode:
	 * 
	 * <tr class="chaptertr active loaded" data-start="0.5" data-end="1.5" data-img="...">
	 * <td class="starttime"><span>00:01</span></td>
	 * <td class="chaptername">Chapter Two</td>
	 * <td class="timecode"><span>0:01</span></td></tr>
	 */
	
	#
	#
	# other (odd chapter for the relive list) - was noch kommt                                                                            
	 ...
	 *  Liste andere:
	 * 
	 * <tr class="chaptertr oddchapter loaded" data-start="0.5" data-end="1.5" data-img="...">
	 * <td class="starttime"><span>00:01</span></td>
	 * <td class="chaptername">Chapter Two</td>
	 * <td class="timecode"><span>0:01</span></td></tr>
	 */
