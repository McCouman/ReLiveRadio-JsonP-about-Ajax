...
setInterval( function jsonp(){
  ...
  var now = new Date();
  url = "http://cm.wikibyte.org/testcodes/neu-chapters/ajax-technik.php?time="+now.getTime()+"&callback=callback";
...
setInterval( function jsonps(){
  ...
  url = "http://cm.wikibyte.org/testcodes/neu-chapters/ajax-technik.php?time="+relivecoverurl.getTime()+"&relivecoverdata=relivecoverdata";
...
setInterval( function jsonps(){
  ...
  url = "http://cm.wikibyte.org/testcodes/neu-chapters/ajax-technik.php?time="+relivetitletturl.getTime()+"&relivetitlenamedata=relivetitlenamedata";
...
setInterval( function jsonps(){
  ...
  url = "http://cm.wikibyte.org/testcodes/neu-chapters/ajax-technik.php?time="+relivedescsurl.getTime()+"&relivedescdata=relivedescdata";
...
setInterval( function jsonps(){
  ...
  url = "http://cm.wikibyte.org/testcodes/neu-chapters/ajax-technik.php?time="+reliveajaxphpurl.getTime()+"&reliveajaxphpdata=reliveajaxphpdata";
