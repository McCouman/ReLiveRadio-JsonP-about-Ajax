...
<?php
/**
*	Kleinere CSS Einheit für Includes später
*/
?>
<style>
...
if (isset($_GET["stream"]) && !empty($_GET["stream"])) {
	...
	global $zahl_liste;
		...
		## No Stream API für Shortcode später!
			...
			echo "Bitte einen Stream angeben! <span style='color:#f00;'>standalone-live.php?stream=</span> <br>mix, mix-mobile, technik, technik-mobile, kultur, kultur-mobile"; 
		}
...
echo "subtitle: '<b>Dein Podcast Radio:</b> Das <a href=\"http://reliveradio.de\">ReliveRadio</a> sendet rund um die Uhr Podcastformate aus ganz verschiedenen Themenbereichen...', \n";
